...
set_target_properties(SimpleAmqpClient PROPERTIES INTERFACE_LINK_LIBRARIES "")

# Expose upstream headers for local build
target_include_directories(
  SimpleAmqpClient
  PUBLIC $<BUILD_INTERFACE:${simple_amqp_client_SOURCE_DIR}/src>)
...
if(CMAKE_CXX_COMPILER_ID STREQUAL "GNU")
  target_compile_options(SimpleAmqpClient PRIVATE -Wno-maybe-uninitialized)
endif()
