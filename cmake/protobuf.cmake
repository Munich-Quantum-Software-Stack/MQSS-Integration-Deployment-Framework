...
function(mqss_configure_proto_target target_name)
  set(PROTO_FILES ${CMAKE_CURRENT_SOURCE_DIR}/protocol/proto/v1/messages.proto)
  ...
  target_sources(${target_name} PRIVATE ${PROTO_FILES})
  ...
  target_include_directories(
    ${target_name} PUBLIC $<BUILD_INTERFACE:${GENERATED_DIR}>
