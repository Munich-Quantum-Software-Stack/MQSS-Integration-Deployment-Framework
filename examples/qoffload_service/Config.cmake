...
set(QOFFLOAD_RUNTIME_DIR "${CMAKE_CURRENT_BINARY_DIR}/runtime"
    CACHE PATH "Default QOffload runtime directory")

set(QOFFLOAD_LOG_DIR "${QOFFLOAD_RUNTIME_DIR}/logs"
    CACHE PATH "Default QOffload log directory")

set(QOFFLOAD_STATE_FILE "${QOFFLOAD_RUNTIME_DIR}/qoffload-state.bin"
