...
using QubitPair = mqss::protocol::v1::QubitPair;
using Backend = mqss::protocol::v1::Backend;
using BackendStatus = mqss::protocol::v1::BackendStatus;
using BackendType = mqss::protocol::v1::BackendType;
using CircuitFormat = mqss::protocol::v1::CircuitFormat;
